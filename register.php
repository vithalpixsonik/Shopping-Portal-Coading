					...
					<div class="col-lg-8 d-none d-lg-block">
						<nav class="mainmenu__nav">
							<ul class="meninmenu d-flex justify-content-start">
								...
								<li class="drop"><a href="#" style="color:#222222">Men</a>
								...
								<li class="drop"><a href="#" style="color:#222222">Women</a>
									<div class="megamenu mega03">
										<ul class="item item03">
											<li class="title">Top Wear</li>
...
<!-- ##########################  Cart Close  ###########################-->
        ...
        <!-- End Bradcaump area -->
<br>
		<div id="form-data" style="margin-top:5%;">
			<div class="container">
				<br><br>
				<div class="row">
				...
				<div class="col-lg-6">
						<form action="register.php" method="POST" style="width:80%;margin-left:10%">
						<p style="font-family:font-family: 'Poppins', sans-serif;color:#323232;font-size:24px;font-weight:500">Register</p>	
							<div class="form-group">
							<br>
							<label for="Name">Name :</label>
							<input type="Name"  class="form-control" id="Name"  name="name" style="border-radius:0;border:2px solid #606060">
							</div>
							
							<div class="form-group">
							<label for="Contact">Contact :</label>
							<input type="tel" class="form-control" id="Contact"  name="contact" style="border-radius:0;border:2px solid #606060">
							</div>

							<div class="form-group">
							<label for="email">Email :</label>
							<input type="email" class="form-control" id="email"  name="email" style="border-radius:0;border:2px solid #606060"> 
							</div>

							<div class="form-group">
							<label for="pwd">Password:</label>
							<input type="password" class="form-control" id="pwd"  name="password" style="border-radius:0;border:2px solid #606060">
							</div>
			
							<button type="submit" name="btn-register" class="btn" style="background-color:#353535;color:white;border-radius:0">Submit</button>
						</form>
						...
						<?php
							...
							if(isset($_POST['btn-register']))
							{
								...
								$sql1="insert into customer_register(ip,name, contact, email,password)
								VALUES ('$ip','$name', '$contact', '$email','$password')";
								if ($con->query($sql1) === TRUE) {
									echo "<p style='color:green;margin-left:10%'>New record created successfully</p>";
								} 
								else {
						...
						?>
						<!-- php Registration Script Close -->
					</div>
				
				<div class="col-lg-6">
				<form action="register.php" method="POST" style="width:80%;margin-left:10%">
					<p style="font-family:font-family: 'Poppins', sans-serif;color:#323232;font-size:24px;font-weight:500">Login</p>
					<br>	
							<div class="form-group">
							<label for="email">Email:</label>
							<input type="email" class="form-control" id="login-email" name="email" style="border-radius:0;border:2px solid #606060">
							</div>
							<div class="form-group">
							<label for="pwd">Password:</label>
							<input type="password" class="form-control" id="login-pwd" name="pass" style="border-radius:0;border:2px solid #606060">
							</div>
							...
							<button type="submit" name="login-btn" class="btn btn-default" style="background-color:#353535;color:white;border-radius:0">Login</button>
						</form>
						...
						<!-- Login Php script -->
							<?php
								...
								if (isset($_POST['login-btn'])){
									...
									$query = "SELECT * FROM `customer_register` WHERE email='$email' and password='".md5($password)."'";
							...
							?>
						<!-- Login Php Script close -->
						<br>
					<hr style="width:65%;margin-left:10%">	
					<p style="margin-left:10%;margin-top:2%">Singup With Email & Facebook</p>
				</div>
