...
<br>
		...
		<p style="text-align:center;font-size:28px;margin-top:5%">Wishlist</p>
                                    ...
                                    <table>
										...
										while($row = $run_pro->fetch_assoc()) {
											...
											if($em==$user_email){
												...
												<td class="product-thumbnail"><a href="#"><img src="dashboard/uploads/featured/'.$row['name'].'".png width="200px" "" alt=""></a></td>
												<td class="product-name"><a href="#">'.$row['name'].'</a></td>
												<td class="product-price"><span class="amount">'.$row['discount_price'].'</span></td>
												<td class="product-stock-status"><span class="wishlist-in-stock">In Stock</span></td>
												<td class="product-add-to-cart"><a href="dashboard/addcart.php?lbl='.$id.'&qty=1"> Add to Cart</a></td>
												<td class="product-remove"><a href="dashboard/removewishlist.php?id='.$id.'">×</a></td>
											</tr>
												';
											}}
											if($em!=$user_email){
												echo '
												<tr>
													<td colspan="6"><p style="text-align:center">No Product Found In your wishlist</p></td>
												</tr>
												';
											}
										}
											...
											echo'
											<tr>
													<td colspan="6"><p style="text-align:center">No Product Found In Your Wishlist. Please Login First</p></td>
												</tr>
											';
										}
										?>
